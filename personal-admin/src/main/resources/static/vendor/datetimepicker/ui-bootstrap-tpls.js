...
/**
 * A utils, internal service that debounces a function
 */
...
/**
 * A utils, internal data structure that acts as a map but also allows getting / removing
...
/**
 * A utils, internal data structure that stores all references attached to key
 */
    ...
    /**
     * A utils directive for the $modal service. It creates a backdrop element.
     */
 ...
 */
   ...
   *   });
        ...
        /**
         * This is a utils function for translating camel-case to snake_case.
         */
...
/**
 * A utils service that can parse typeahead's syntax (string provided by users)
