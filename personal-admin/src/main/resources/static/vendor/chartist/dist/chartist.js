 ...
 */
    ...
    (function (window, document, Chartist) {
        ...
        /**
         * Functional style utils to produce array with given length initialized with undefined values
         *
         * @memberof Chartist.Core
         * @param length
         * @return {Array}
        ...
        /**
         * Sum utils to be used in reduce functions
         *
         * @memberof Chartist.Core
         * @param previous
         * @param current
        ...
        /**
         * This utils function can be used to round values with certain precision level after decimal. This is used to prevent rounding errors near float point precision limit.
         *
         * @memberof Chartist.Core
   ...
   * });
        ...
        /**
         * This utils class is to wrap multiple `Chartist.Svg` elements into a list where you can call the `Chartist.Svg` functions on all elements in the list with one call. This is helpful when you'd like to perform calls with `Chartist.Svg` on multiple elements.
